		 ...
		 keyMap: {					// not required
			...
			"key": "t"
                ...
                {id: 2,                                                 // ids must be unique
                 label: 'Pick a State RERL Site',
                 layer: 'massgis:DMARRIER.RERL_FINAL_STATE_SITES',
                 valueField: 'SITE_NUM',
                 sortBy : 'SITE_NUM', // optional, fieldname
                 sortOrder : 'A', // optional, acceptable values = A, D
                 keyMap: {                                      // not required
                        "ctrl":true,                    // not required if false
                        "alt": true,                    // not required if false
                ...
                {id: 3,                                                 // ids must be unique
                 label: 'Pick a Non-State RERL Site',
                 layer: 'massgis:DMARRIER.RERL_FINAL_NONSTATE_SITES',
                 valueField: 'SITE_NUM',
                 sortBy : 'SITE_NUM', // optional, fieldname
                 sortOrder : 'A', // optional, acceptable values = A, D
                 keyMap: {                                      // not required
