...
*/
  ...
  ,button : {
     icon    : 'img/filter.png'
    ,scale   : 'medium'
    ,tooltip : 'Parcels filter'
    ,id      : 'filterBuilderButton'
    ,menu    : [
      {
         text : 'Launch filter builder'
        ,handler :  function() {
          ...
          win = new Ext.Window({
            ...
            ,items    : new Ext.FormPanel({
              ...
              ,buttons      : [
                ...
                ,{
                   text    : 'Reset'
                  ,handler : function() {
                    Ext.getCmp('filterBuilderButton').toggle(true);
            ...
            ,listeners : {
              hide        : function(win) {
                var lyr = map.getLayersByName(toolSettings.filter.wmsLayerName)[0];
                if (lyr.params.FILTER && lyr.params.FILTER != '') {
                  Ext.getCmp('filterBuilderButton').toggle(true);
                }
                else {
