...
-->
    <script>
      ...
      var foldersetLoc = '/temp/brimfield_folderset.xml';
...
var bannerHTML = '<table border="0" style="font-family:Arial;font-size:22"><tr><td><a target="_blank" href="http://www.brimfieldma.org"><img src="img/brimfield_seal_color.png" alt="Brimfield, MA town seal"/></a></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><font size=+3>MuniMapper: Brimfield, MA</font><br/><font size=-1><a target="_blank" href="http://www.brimfieldma.org/">Town of Brimfield Web Site</a><br/><a target="_blank" href="munimapper_disclaimer.html">Disclaimer<font></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><img src="img/munimapper_web.png" alt="MuniMapper logo"></td></tr>';
...
//       },
    ...
    <script>
      ...
      siteTitle    = 'MuniMapper: Brimfield, MA';
      siteUrl      = 'http://maps.massgis.state.ma.us/map_ol/brimfield.php';
    </script>

	<!-- include a set of tool configs -->
	<script type="text/javascript" src="js/toolConfig_brimfield.js?<?php echo time(); ?>"></script>	
	<script type="text/javascript" src="js/toolConfig_sample_filter_brimfield.js?<?php echo time(); ?>"></script>	
    <script>
