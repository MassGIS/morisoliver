...
-->
    <script>
      ...
      var foldersetLoc = '/temp/innovation_proj_folderset.xml';
...
//        ,{wms : 'massgis:GISDATA.ACS0610_HH_LOW_INC_POLY'  ,title : 'More than 60% households less than $75,000'}
        ,{wms : 'massgis:GISDATA.GATEWAY_CITIES_POLY'	   ,title : 'Gateway Cities'}
//        ,{wms : 'massgis:GISDATA.L3_TAXPAR_POLY_ASSESS'  ,title : 'Parcels Level 3 SDE'}
...
//        ,{wms : 'massgis:GISDATA.NAVTEQRDS_ARC'	   ,title : 'Streets for Query'}
      ...
      var bannerHTML = '<table style="font-family:Arial"><tr><td>&nbsp;&nbsp;</td><td><font size="+2"><b>Innovation Project Eligibility Areas</b></font></td></tr>';
      var bannerHeight = 40;
      var externalGetCaps = {
...
//       },
    ...
    <script>
      ...
      siteTitle    = 'Innovation Project Eligibility Areas';
      siteUrl      = 'http://maps.massgis.state.ma.us/map_ol/innovation_proj.php';
    </script>

	<!-- include a set of tool configs -->
	<script type="text/javascript" src="js/toolConfig_innovation_proj.js?<?php echo time(); ?>"></script>	
