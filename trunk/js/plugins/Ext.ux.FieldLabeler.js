...
                },
                html: ( this.optionalField ? "<span ext:qtip='"+(this.optionalText ? this.optionalText : "This question is optional") + "'>" + this.fieldLabel+ "<span class='x-optional'>*</span></span>" : this.fieldLabel ) + (this.labelSeparator || ':') 
            });
        },
 
//      private
